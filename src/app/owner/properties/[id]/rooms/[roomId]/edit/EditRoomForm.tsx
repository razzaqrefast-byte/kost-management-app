...
export default function EditRoomForm({
    ...
    return (
        <form action={handleSubmit} className="space-y-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            ...
            <div>
                <label htmlFor="manualStatus" className="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">
                    Status Ketersediaan (Manual)
                </label>
                <div className="mt-2">
                    <select
                        id="manualStatus"
                        name="manualStatus"
                        defaultValue={room.manual_status || 'available'}
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:max-w-xs sm:text-sm sm:leading-6 dark:bg-gray-700 dark:text-white dark:ring-gray-600"
                    >
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Gunakan 'Dalam Perbaikan' untuk menyembunyikan kamar ini dari pencarian penyewa.
                </p>
            </div>
